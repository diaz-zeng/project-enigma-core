...
- **参数**
  - `{Array<{value1:number,value2:number}>} setting` 反射器配置
- **说明**：
  - 设置新的反射器配置。
- **返回值**：
  - `{Enigma}` 当前实例
...
- **参数**
  - `{Array<Array<number>>} setting` 转子组配置
- **说明**：
...
- **参数**
  - `{Array<{value1: string, value2: string}>} setting` 字符映射配置
- **说明**：
